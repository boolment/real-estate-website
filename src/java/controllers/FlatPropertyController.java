...
@WebServlet("/FlatPropertyController.do")
public class FlatPropertyController extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(FlatPropertyController.class);
