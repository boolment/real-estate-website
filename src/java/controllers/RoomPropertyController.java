...
@WebServlet("/RoomPropertyController.do")
public class RoomPropertyController extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(RoomPropertyController.class);
