                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="register">
                            ...
                            <form >
                                ...
                                <!--                            <div class="row">
                                                                <div class="col-sm-12 form-group">
                                                                    <input type="password" class="form-control" id="fname" name="fname" placeholder="********">
                                                                </div>
                                                            </div>-->
                                <div class="row">
                                    <div class="col-sm-12">
                                        <button class="scheduleBtn">Log In</button>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-12">
                                        <a href="http://localhost:8080/othogo/register.jsp" class="scheduleBtn">Register Now</a>
                                    </div>
                                </div>
