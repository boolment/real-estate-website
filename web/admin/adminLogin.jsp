            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-9" id="siginDiv">
                        <div class="loginForm">
                            <h1>Login <small>Admin Member login area</small></h1>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="adminPassword" id="aPassword" placeholder="***********" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary" id="adminSignIn">Sign In</button>                            
                        </div>
                    </div>
